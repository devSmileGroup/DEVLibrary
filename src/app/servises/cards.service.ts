...
import { LoadCards, AddCard, DeleteCard, UpdateCard } from "../redux/actions/cards.action";
...
export class CardsService {
        ...
        const promise = new Promise((res, rej) => {
            ...
            this.http.get(CardsService.BASE_URL + 'cards')
                ...
                .then((cards: Card[]) => {
                    ...
                    this.store.dispatch(new LoadCards(nCards, 21))
                })
        })
        return promise
    ...
    addCard(card: Card) {
        this.http.post(CardsService.BASE_URL + 'cards', card)
            ...
            .toPromise()
            .then(() => {
                this.paginationCard(this.searchText, this.numberPage)
            })
    }
